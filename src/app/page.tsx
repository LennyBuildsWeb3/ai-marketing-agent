...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-blue-950 to-slate-900">
      <header className="border-b border-blue-800/30 bg-slate-950/80 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-white font-bold text-xl tracking-tight">Marketing Agent</h1>
              <p className="text-blue-300 text-xs">Enterprise Content Platform</p>
            </div>
          </div>
          <a
            href="https://github.com/LennyBuildsWeb3/ai-marketing-agent"
            target="_blank"
            className="text-blue-300 hover:text-white transition-colors text-sm flex items-center gap-2"
          >
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        <div className="inline-block px-4 py-1 rounded-full bg-blue-900/50 text-blue-300 text-sm mb-6 border border-blue-700/30">
        ...
        <p className="text-slate-400 text-lg max-w-2xl mx-auto">
          Enterprise-grade content generation platform. Create professional content for Twitter, LinkedIn, Instagram, and blogs.
        </p>
      </section>

      <section className="max-w-4xl mx-auto px-6 pb-20">
        <div className="bg-slate-900/70 backdrop-blur-sm rounded-2xl border border-blue-800/30 p-8 shadow-xl">
          <div className="mb-6">
            <label className="text-slate-300 text-sm mb-2 block font-medium">Select Platform</label>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div>
              <label className="text-slate-300 text-sm mb-2 block font-medium">Topic / Product</label>
              <input
                type="text"
                value={topic}
            ...
            <div>
              <label className="text-slate-300 text-sm mb-2 block font-medium">Key Benefit</label>
              <input
                type="text"
                value={benefit}
          ...
          <button
            ...
            className="w-full py-4 rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold text-lg hover:from-blue-500 hover:to-blue-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-blue-600/20"
          >
            {isGenerating ? (
              <>
          ...
          {generatedContent && (
            <div className="mt-6">
              <div className="flex items-center justify-between mb-2">
                <label className="text-slate-300 text-sm font-medium">Generated Content</label>
                <button
              ...
              <div className="bg-slate-950 rounded-lg p-4 border border-slate-700">
                <pre className="text-slate-200 whitespace-pre-wrap font-sans">{generatedContent}</pre>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <div className="bg-slate-900/50 rounded-xl p-6 border border-blue-800/20">
            ...
            <p className="text-slate-400 text-sm">Your data stays private. No tracking, no storage, fully secure.</p>
          </div>
          <div className="bg-slate-900/50 rounded-xl p-6 border border-blue-800/20">
            <div className="w-12 h-12 rounded-lg bg-blue-900/50 flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-slate-400 text-sm">Trusted by thousands of marketers worldwide.</p>
          </div>
          <div className="bg-slate-900/50 rounded-xl p-6 border border-blue-800/20">
            <div className="w-12 h-12 rounded-lg bg-blue-900/50 flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-slate-400 text-sm">Create professional content in seconds, not hours.</p>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-blue-900/30 py-8">
        <div className="max-w-6xl mx-auto px-6 text-center text-slate-500 text-sm">
          <p>Built for the Sentient Builder Program</p>
          <p className="mt-1">
            <a href="https://github.com/LennyBuildsWeb3/ai-marketing-agent" className="text-blue-400 hover:text-blue-300">GitHub</a>
            {" • "}
            <a href="https://x.com/LennyBuilds" className="text-blue-400 hover:text-blue-300">Twitter</a>
          </p>
        </div>
      </footer>
    </div>
